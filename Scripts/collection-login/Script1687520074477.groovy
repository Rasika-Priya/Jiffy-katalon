...
WebUI.setText(findTestObject('Object Repository/reminder/Page_Login/input_Username_email'), Username)

WebUI.setText(findTestObject('Object Repository/reminder/Page_Login/input_Password_password'), Password)
